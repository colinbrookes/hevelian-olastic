...
public interface ESMultiResponseParser<T, V> {
     ...
     * @param responseEntitySet
     *            entitySet of the data returned from Elasticsearch
     ...
     */
    InstanceData<T, V> parse(MultiSearchResponse response, ElasticEdmEntitySet responseEntitySet, ElasticEdmEntitySet returnEntitySet)
            throws ODataApplicationException;
}
