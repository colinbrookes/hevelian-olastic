...
/**
 * Wraps olingo literal data.
 * All methods in this class are used when literal is at the left position of binary expression:
 * '25' gt age
 * In this case operation is reversed:
 * age lt '25'
 * and execution is delegated to the left part member
 *
 * @author Taras Kohut
 */
public class LiteralMember extends BaseMember {
    ...
    /**
     * Checks the edm type of the string value, and creates concrete type from this value
     *
