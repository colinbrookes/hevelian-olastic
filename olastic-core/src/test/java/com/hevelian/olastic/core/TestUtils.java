...
public class TestUtils {
    ...
    /**
     * Checks if ES query for equals filter by grand-parent's property is
     * correct
     * 
     * @param query
     *            ESQuery
    ...
    private static void checkFilterEqualsQueryInternal(String query, String field, String value,
            boolean isNotQuery) {
        JSONObject queryObj = new JSONObject(query);
        JSONObject rootObj;
    ...
    private static void checkFilterParentEqualsQueryInternal(String query, String parent,
            String field, String value, boolean isNotQuery) {
